describe('calculator app', () => {
  ...
  it('Pressing multiple operator buttons in sequence - last operator pressed is used for calculation', () =>{
    cy.get('#button9').click()
    cy.get('#buttonAddition').click()
    cy.get('#buttonSubtraction').click()
    cy.get('#button4').click()
  ...
  it('Pressing the same operator button multiple times does nothing - Addition', () =>{
    cy.get('#button4').click()
    cy.get('#buttonAddition').click()
    cy.get('#buttonAddition').click()
    cy.get('#display').should('have.text', '4')
  ...
  it('Pressing the same operator button multiple times does nothing - Subtraction', () =>{
    cy.get('#button6').click()
    cy.get('#buttonSubtraction').click()
    cy.get('#buttonSubtraction').click()
    cy.get('#display').should('have.text', '6')
  ...
  it('Pressing the same operator button multiple times does nothing - Multiplication', () =>{
    cy.get('#button6').click()
    cy.get('#buttonMultiplication').click()
    cy.get('#buttonMultiplication').click()
    cy.get('#display').should('have.text', '6')
  ...
  it('Pressing the same operator button multiple times does nothing - Division', () =>{
    cy.get('#button6').click()
    cy.get('#buttonDivision').click()
    cy.get('#buttonDivision').click()
    cy.get('#display').should('have.text', '6')
